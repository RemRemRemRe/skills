...
- **[batch-grill-with-docs](./batch-grill-with-docs/SKILL.md)** — Batch-grill a plan by its current decision frontier, capturing glossary terms and ADRs as you go. ([Source](https://github.com/BjornMelin/dev-skills/blob/main/skills/batch-grill-with-docs/SKILL.md))
- **[pre-mortem](./pre-mortem/SKILL.md)** — Assume the plan already failed and work backwards to surface risky assumptions and irreversible bets. ([Source](https://github.com/BjornMelin/dev-skills/blob/main/skills/batch-grill-with-docs/SKILL.md))
